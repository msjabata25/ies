    ...
    <nav ref={navRef} className="fixed top-0 left-0 w-full z-40 opacity-0 bg-[#131313]/80 backdrop-blur-xl border-b-2 border-[#F57C00] shadow-[0_0_15px_rgba(245,124,0,0.3)]">
      <div className="max-w-7xl mx-auto px-6 h-16 flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-4 text-white">
          ...
          <span className="material-symbols-outlined hover:text-[#F57C00] transition-colors cursor-pointer" data-weight="fill" style={{ fontVariationSettings: "'FILL' 1" }}>power_settings_new</span>
        </div>
      </div>
    </nav>
  );
