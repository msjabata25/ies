...
export default function Hero() {
  ...
  useGSAP(() => {
    ...
    tl.to('.hero-logo', { opacity: 1, scale: 1, rotation: 360, duration: 0.8, ease: 'back.out(1.7, 0.3)' }, 'letters+=1.2');
    ...
    tl.to('.sys-coord', { opacity: 0.5, duration: 0.5 }, 'letters+=2.5');
  }, { scope: container });
      ...
      <div className="flex items-center w-full max-w-7xl mx-auto z-10">
        <div className="w-full z-10 text-left">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-4">
            ...
            <h1 className="font-display text-[#F57C00] text-[5xl] md:text-[84px] leading-none tracking-widest">
              ...
              <span className="hero-rest opacity-0">TEM BOOT <br className="hidden md:block"/> SEQUENCE_</span>
            </h1>
          </div>
